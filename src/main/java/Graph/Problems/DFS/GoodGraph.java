...
public class GoodGraph {
    ...
    public static void DFSTopologicalSort(ArrayList<ArrayList<Integer>> adj, boolean[] visited, Stack<Integer> stack, int src) {
        visited[src] = true;

        for (int n : adj.get(src)) {
            if (visited[n] == false) {
                DFSTopologicalSort(adj, visited, stack, n);
            }
        }
    ...
    public void DFS(ArrayList<ArrayList<Integer>> adj, boolean[] visited, int S) {
        visited[S] = true;
    ...
    public void solve(ArrayList<Integer> A) {
        ...
        boolean[] good = new boolean[adj.size()];
...
//        );
        ...
        GoodGraph g = new GoodGraph();
        g.solve(A);
        System.out.println("A.size() - " + (A.size()));
        System.out.println("disconnectedCount - " + (g.disconnectedCount - 1));
    }
}
